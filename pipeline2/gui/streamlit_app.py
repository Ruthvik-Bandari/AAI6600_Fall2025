...
with tab2:
    ...
    with col1:
        city_input = st.text_input("🏙️ City", placeholder="e.g., Boston", key="search_city")
    
    with col2:
        state_input = st.text_input("🗺️ State", placeholder="e.g., MA", key="search_state")
